APPCFG = {
	...
	HEADER_LINK_TEXT: "The Seventh Generation: Stories from the Marcellus Shale",
	HEADER_LINK_URL: "http://susquehannawritersinstitute.blogs.bucknell.edu/",
	...
	PIN_CFG: {
		...
		y: {
			iconPath: 'resources/markers/yellow/Numbericon',
